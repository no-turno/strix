...
export interface Bucket extends Auditable {
  "subpaths": Subpath[];
  "name": string;
}
export interface Directory extends Auditable {
  "files": File[];
  "name": string;
...
export interface FileSystem extends Auditable {
  "paths": Directory[];
}
export interface Subdirectory extends Auditable {
  "directory"?: Directory | null;
  "name": string;
}
export interface Subpath extends Auditable {
  "files": File[];
  "name": string;
}
...
export interface Token extends Auditable {
  "expires_at": Date;
  "value": string;
}
...
export interface UserSession extends Auditable {
  "id": string;
  "tokens": Token[];
  "user": User;
}
